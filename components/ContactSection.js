...
export default function ContactSection() {
  ...
  return (
    <>
        ...
        <div className="relative w-auto my-6 mx-auto max-w-3xl z-20 ">
          ...
          <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-[#2d253a] outline-none focus:outline-none">
            ...
            <div className="flex items-center p-5 border-b border-solid border-slate-200 rounded-t justify-center">
              <h3 className="text-3xl font-semibold text-white">Thanks for submit</h3>
            </div>
            {/*body*/}
            {/*footer*/}
      ...
      {showModal && <div className="opacity-25 fixed inset-0 z-10 bg-black"></div>}
      {loading && (
        <div className="mx-auto sm:w-3/4 md:w-2/4 fixed inset-x-0 top-[45%]" id="signin-success-message">
          <div className="bg-green-300 opacity-90 px-6 py-1 my-2 rounded-md text-lg flex items-center w-full content-center justify-center">
            <Typewriter
              options={{
                strings: ["wait a second...", "dont wink your eyes... 🤩"],
                autoStart: true,
                loop: true,
                delay: 85,
                deleteSpeed: 50,
          ...
          <div className="md:w-6/12 w-full">
            <form className="lg:py-16 lg:px-20 md:p-14 p-10">
              ...
              <div className="text-right">
                ...
                <button
                  className="transition mt-2 py-3 px-10 cursor-pointer font-semibold text-sm inline-block bg-green-400 hover:bg-opacity-90 text-white"
                  onClick={contactMe}
                >
                  Send
                </button>
